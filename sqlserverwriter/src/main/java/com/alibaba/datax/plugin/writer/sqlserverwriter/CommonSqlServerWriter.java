...
public class CommonSqlServerWriter {
    ...
    public static class Task {
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            this.updateKeys = writerSliceConfig.getList("updateKey", String.class);
        ...
        protected void doOneInsert(Connection connection, List<Record> buffer) {
            ...
            try {
                ...
                for (Record record : buffer) {
                    try {
                        preparedStatement = fillOnePreparedStatement(
                                preparedStatement, record);
        ...
        protected PreparedStatement fillOnePreparedStatement(PreparedStatement preparedStatement, Record record)
                throws SQLException {
        /*
            语句示例：
            ...
            begin
            insert into tb(id,name) select '123' , '456'
            end
        */
        ...
        private void calcWriteRecordSql(Boolean isBatch) {
            ...
            INSERT_OR_REPLACE_TEMPLATE = SqlServerWriterUtil.getWriteTemplate(this.table, columns, updateKeys, valueHolders, isBatch);
            writeRecordSql = INSERT_OR_REPLACE_TEMPLATE;
        }
